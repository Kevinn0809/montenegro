...
router.get('/obtenerusuario/:id', usuarioController.obtenerUnUsuario)
...
router.get('/obtener-all-productos', productoControlador.ObtenerAllProductos)
...
router.put('/edit-producto/:id', productoControlador.EditarProducto)
//Ruta para eliminar un producto por su id 
router.delete('/eliminar-producto/:id', productoControlador.eliminarProducto)
